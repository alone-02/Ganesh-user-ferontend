  ...
  return (
    ...
    <div className="max-w-3xl mx-auto bg-white border border-gray-300 rounded-lg shadow-lg">
      ...
      <div className="px-6 py-6">
        <h2 className="text-2xl font-semibold text-gray-800 mb-2">Address Information</h2>
        <p className="text-gray-600 mb-6 text-sm">Use a permanent address where you can receive orders.</p>
        ...
        <form className="space-y-6" onSubmit={addAddress}>
          ...
          <div>
            ...
            <input
              ...
              className="mt-1 block w-full border border-gray-300 rounded-lg shadow-sm p-3 focus:ring-blue-500 focus:border-blue-500"
            />
            {error.address1 && <p className="text-red-500 text-sm mt-1">{error.address1}</p>}
          </div>
